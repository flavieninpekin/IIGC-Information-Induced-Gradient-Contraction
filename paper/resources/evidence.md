...
| 结果 | 证据 |
|---|---|
| "75% 谷"死亡（n=6 回归均值，ANOVA F=0.756 p=0.759） | `data/kappa/510k_reveal/results.json`（⚠️ 2026-09-23：未掩码测量，已作废，见 `data/kappa/510k_reveal/INVALID.md`）、`research_status.md` §2.7 |
