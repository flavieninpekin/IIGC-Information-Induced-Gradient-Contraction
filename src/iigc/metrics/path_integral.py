...
from iigc.envs._510k.features import extract_features, FEATURE_NAMES, FEATURE_DIM
from iigc.envs._510k.scorer import Scorer
import random

ROOT = os.path.abspath(os.path.join(os.path.dirname(__file__), '..', '..', '..'))
MODEL_DIR = os.path.join(ROOT, 'data', 'models_selfplay')
OUTPUT_DIR = os.path.join(ROOT, 'data', 'path_data')
